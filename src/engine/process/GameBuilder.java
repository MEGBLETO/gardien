...
public class GameBuilder {
	...
	private static void intializeGuardian(Map map, MobileElementManager manager) {
		...
		Guardian guardian6 = new Guardian(blockGUARD6);
